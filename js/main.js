$(function(){
    ...
    $('._surf').on('click', function (e) {
        $('html,body').stop().animate({ scrollTop: $('#surf').offset().top }, 1000);
        e.preventDefault();
    });
    $('._travel').on('click', function (e) {
        $('html,body').stop().animate({ scrollTop: $('#travel').offset().top }, 1000);
        e.preventDefault();
    });
    $('._sleep').on('click', function (e) {
        $('html,body').stop().animate({ scrollTop: $('#sleep').offset().top }, 1000);
        e.preventDefault();
    });
    $('._shop').on('click', function (e) {
        $('html,body').stop().animate({ scrollTop: $('#shop').offset().top }, 1000);
        e.preventDefault();
    });
    ...
    $('.quantity-button').on('click', function () {
        ...
        let summ = $('.summ', parents).data('night') * $('.night', parents).val() + $('.summ', parents).data('guests') * $('.guests', parents).val();
